...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-insurance');?>
        
        <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/multipurpose/');?>" target="_blank">
        <?php esc_html_e('SKT Multipurpose Themes','skt-insurance'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
